...
import static ni.edu.mney.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static ni.edu.mney.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static ni.edu.mney.test.util.OAuth2TestUtil.testAuthenticationToken;
