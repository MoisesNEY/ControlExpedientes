...
INSERT INTO expediente_clinico (id, numero_expediente, fecha_apertura, observaciones) VALUES
    ...
    (9, 'EXP-2026-0309', '2026-03-26', 'Control digestivo y vigilancia de anemia.'),
    (10, 'EXP-2026-0310', '2026-03-27', 'Seguimiento por dermatitis y alergias estacionales.'),
    (11, 'EXP-2026-0311', '2026-03-28', 'Evaluación geriátrica por osteoartrosis e hipertensión.'),
    (12, 'EXP-2026-0312', '2026-03-29', 'Control adolescente por migraña y hábitos de sueño.');
...
INSERT INTO paciente (id, codigo, nombres, apellidos, sexo, fecha_nacimiento, cedula, telefono, direccion, estado_civil, email, activo, expediente_id) VALUES
    ...
    (9, 'PAC-260309', 'Gloria Mercedes', 'Ramirez Silva', 'FEMENINO', '1972-05-28', '001-280572-0009I', '8888-9090', 'Jinotepe, Nicaragua', 'CASADO', 'gloria.ramirez@example.com', true, 9),
    (10, 'PAC-260310', 'Byron Alexis', 'Castillo Perez', 'MASCULINO', '1990-10-15', '001-151090-0010J', '8888-1112', 'Chinandega, Nicaragua', 'SOLTERO', 'byron.castillo@example.com', true, 10),
    (11, 'PAC-260311', 'Teresa del Carmen', 'Ruiz Lagos', 'FEMENINO', '1958-03-19', '001-190358-0011K', '8888-1212', 'Boaco, Nicaragua', 'VIUDO', 'teresa.ruiz@example.com', true, 11),
    (12, 'PAC-260312', 'Luis Fernando', 'Mairena Soto', 'MASCULINO', '2008-08-07', '001-070808-0012L', '8888-1313', 'Managua, Nicaragua', 'SOLTERO', 'luis.mairena@example.com', true, 12);
...
INSERT INTO cita_medica (id, fecha_hora, estado, observaciones, user_id, paciente_id) VALUES
    ...
    (13, '2026-03-26 11:10:00', 'ATENDIDA', 'Control digestivo por dispepsia y mareos.', NULL, 9),
    (14, '2026-03-27 14:25:00', 'ATENDIDA', 'Valoración por dermatitis pruriginosa recurrente.', NULL, 10),
    (15, '2026-03-28 08:50:00', 'ATENDIDA', 'Seguimiento geriátrico por dolor articular crónico.', NULL, 11),
    (16, '2026-03-29 10:30:00', 'PROGRAMADA', 'Control de cefalea y hábitos de sueño.', NULL, 12);
...
INSERT INTO consulta_medica (id, fecha_consulta, motivo_consulta, notas_medicas, user_id, expediente_id) VALUES
    ...
    (9, '2026-03-26', 'Dispepsia y cansancio', 'Molestia epigástrica postprandial y datos de anemia leve en estudios recientes.', NULL, 9),
    (10, '2026-03-27', 'Dermatitis pruriginosa', 'Lesiones eritematosas localizadas sin signos de sobreinfección.', NULL, 10),
    (11, '2026-03-28', 'Dolor articular crónico', 'Limitación funcional leve por osteoartrosis de rodilla y control de presión arterial.', NULL, 11),
    (12, '2026-03-29', 'Cefalea tensional recurrente', 'Se identifican hábitos inadecuados de sueño y uso prolongado de pantallas.', NULL, 12);
...
INSERT INTO diagnostico (id, descripcion, codigo_cie, consulta_id) VALUES
    ...
    (10, 'Dispepsia funcional', 'K30', 9),
    (11, 'Anemia ferropénica leve', 'D509', 9),
    (12, 'Dermatitis alérgica de contacto', 'L239', 10),
    (13, 'Osteoartrosis primaria de rodilla', 'M170', 11),
    (14, 'Cefalea tensional', 'G442', 12);
...
INSERT INTO signos_vitales (id, peso, altura, presion_arterial, temperatura, frecuencia_cardiaca, consulta_id) VALUES
    ...
    (9, 69.3, 1.57, '118/78', 36.5, 74, 9),
    (10, 77.8, 1.72, '120/76', 36.7, 80, 10),
    (11, 62.5, 1.55, '140/86', 36.4, 72, 11),
    (12, 58.9, 1.68, '112/70', 36.6, 77, 12);
...
INSERT INTO tratamiento (id, indicaciones, duracion_dias, consulta_id) VALUES
    ...
    (9, 'Fraccionar alimentos, evitar irritantes gástricos y reforzar consumo de hierro.', 30, 9),
    (10, 'Evitar contacto con irritantes, mantener hidratación cutánea y vigilancia de lesiones.', 14, 10),
    (11, 'Ejercicios de bajo impacto, control del dolor y seguimiento de tensión arterial.', 30, 11),
    (12, 'Higiene del sueño, pausas visuales y diario de cefaleas.', 21, 12);
...
INSERT INTO receta (id, dosis, frecuencia, duracion, medicamento_id, consulta_id, cantidad) VALUES
    ...
    (11, '20 mg', 'Cada 24 horas antes del desayuno', '30 días', 4, 9, 30),
    (12, '10 mg', 'Cada 24 horas', '14 días', 5, 10, 14),
    (13, '100 mg', 'Cada 24 horas', '30 días', 11, 11, 30),
    (14, '500 mg', 'Cada 8 horas si hay cefalea', '7 días', 1, 12, 21);
...
INSERT INTO historial_clinico (id, fecha_registro, descripcion, expediente_id) VALUES
    ...
    (17, '2026-03-26 10:55:00', 'Paciente refiere plenitud postprandial y fatiga progresiva.', 9),
    (18, '2026-03-26 11:40:00', 'Se reforzó dieta rica en hierro y protección gástrica.', 9),
    (19, '2026-03-27 14:05:00', 'Dermatitis relacionada con exposición a detergentes.', 10),
    (20, '2026-03-27 15:00:00', 'Se indicó control de piel y medidas de barrera.', 10),
    (21, '2026-03-28 08:35:00', 'Valoración funcional por dolor crónico de rodilla.', 11),
    (22, '2026-03-28 09:25:00', 'Se entregó plan de ejercicios suaves y control de presión.', 11),
    (23, '2026-03-29 10:10:00', 'Adolescente con mala higiene del sueño y cefalea frecuente.', 12),
    (24, '2026-03-29 10:55:00', 'Se programó seguimiento para diario de síntomas.', 12);
...
INSERT INTO auditoria_acciones (id, entidad, accion, fecha, descripcion, user_id) VALUES
    ...
    (17, 'Paciente', 'CREAR', '2026-03-26 10:40:00', 'Registro de PAC-260309 para control digestivo.', NULL),
    (18, 'ConsultaMedica', 'CREAR', '2026-03-26 11:12:00', 'Consulta 9 documentada con manejo digestivo.', NULL),
    (19, 'Receta', 'CREAR', '2026-03-26 11:28:00', 'Omeprazol indicado para consulta 9.', NULL),
    (20, 'Paciente', 'CREAR', '2026-03-27 13:55:00', 'Alta administrativa de PAC-260310.', NULL),
    (21, 'ConsultaMedica', 'CREAR', '2026-03-27 14:28:00', 'Consulta dermatológica 10 registrada.', NULL),
    (22, 'ConsultaMedica', 'CREAR', '2026-03-28 08:58:00', 'Consulta geriátrica 11 completada.', NULL),
    (23, 'Receta', 'CREAR', '2026-03-28 09:08:00', 'Aspirina prescrita para control vascular en consulta 11.', NULL),
    (24, 'CitaMedica', 'CREAR', '2026-03-29 09:45:00', 'Se agenda cita 16 para PAC-260312.', NULL);
...
INSERT INTO resultado_laboratorio (id, tipo_examen, resultado, valor_referencia, unidad, observaciones, fecha_examen, paciente_id, consulta_id) VALUES
    ...
    (5, 'Hemoglobina', '10.9', '12-16', 'g/dL', 'Compatible con anemia leve de probable origen ferropénico.', '2026-03-25', 9, 9),
    (6, 'Velocidad de sedimentación globular', '16', '0-20', 'mm/h', 'Sin elevación significativa para proceso inflamatorio severo.', '2026-03-27', 10, 10);
