...
public class SignosVitalesResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<SignosVitalesDTO> createSignosVitales(@RequestBody SignosVitalesDTO signosVitalesDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/signos-vitales/" + signosVitalesDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, signosVitalesDTO.getId().toString()))
    ...
    public ResponseEntity<SignosVitalesDTO> updateSignosVitales(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, signosVitalesDTO.getId().toString()))
            .body(signosVitalesDTO);
    }
    ...
    public ResponseEntity<SignosVitalesDTO> partialUpdateSignosVitales(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, signosVitalesDTO.getId().toString())
        );
    }
