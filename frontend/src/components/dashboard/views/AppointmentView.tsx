    ...
    return (
        <div className="p-8 space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-2xl font-black text-slate-900 dark:text-white">Agenda de Citas</h2>
                    <p className="text-slate-500 text-sm font-medium">Gestiona tus consultas programadas y pacientes en espera.</p>
                </div>
            </div>
